...
import NotableProjects from '@/components/NotableProjects.vue';
import LayoutDefault from '@/components/layouts/default.vue';

export default {
	components: {NotableProjects, LayoutDefault},
	computed: {
		projects: () => data,
		notables: () => notable,
	...
	methods: {
		img(src) {
			return new URL(`/src/assets/images/work/${src}`, import.meta.url).href;
		}
	}
}
</script>
				...
				<div class="col-12 position-relative">
					...
					<div id="work-container" :class="{invisible: !showWork}">
						<div class="card" macy-complete="1" v-for="(project, index) in projects" :key="index">
							<img :src="img(project.image)" class="card__image">
							<div class="px-3 py-2">
